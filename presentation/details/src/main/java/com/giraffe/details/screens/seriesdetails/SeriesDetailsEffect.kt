...
interface SeriesDetailsEffect {
    ...
    data class NavigateToCastDetails(val personId: Int) : SeriesDetailsEffect

    data class NavigateToSeasons(val seriesId: Int) : SeriesDetailsEffect
    ...
    object NavigateToLogin : SeriesDetailsEffect

    object OnBackButtonClick : SeriesDetailsEffect


    data class NavigateToYouTubePlayer(val url: String) : SeriesDetailsEffect
}