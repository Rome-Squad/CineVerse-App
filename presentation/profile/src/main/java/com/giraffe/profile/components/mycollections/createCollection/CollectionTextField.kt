...
fun CollectionTextField(
    ...
    OutlinedTextField(
        ...
        modifier = Modifier.border(width = 1.dp, color = Theme.color.stroke.primary).fillMaxWidth(),
        ...
        placeholder = {
            Text(
                ...
                modifier = Modifier
                    .padding(top = 14.5.dp, bottom = 14.5.dp)
        ...
        leadingIcon = {
            Icon(
                ...
                modifier = Modifier
                    .padding(start = 16.dp, top = 14.dp, bottom = 14.dp, end = 0.5.dp)
            )
        },
        colors = TextFieldDefaults.outlinedTextFieldColors(
            backgroundColor = Theme.color.background.card,
            focusedBorderColor = Theme.color.brand.primary,
            unfocusedBorderColor = Theme.color.stroke.primary
